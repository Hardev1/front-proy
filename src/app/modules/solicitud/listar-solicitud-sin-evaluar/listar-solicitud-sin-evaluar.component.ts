...
@Component({
  ...
  templateUrl: './listar-solicitud-sin-evaluar.component.html',
  styleUrls: ['./listar-solicitud-sin-evaluar.component.css']
})
export class ListarSolicitudSinEvaluarComponent implements OnInit, AfterViewInit {
  ...
  displayedColumns: string[] = ['id', 'fecha', 'tipoSol', 'nombre_solicitud', 'archivo', 'descripcion', 'posee_un', 'pertenece_a', 'tiene_una', 'acciones'];
  columnas = [
    { titulo: "ID", name: "id" },
  ...
  GetRecordList() {
    this.service.SinEvaluar().subscribe({
