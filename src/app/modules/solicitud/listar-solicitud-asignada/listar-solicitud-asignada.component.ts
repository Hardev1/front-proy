...
@Component({
  ...
  templateUrl: './listar-solicitud-asignada.component.html',
  styleUrls: ['./listar-solicitud-asignada.component.css'] 
})
export class ListarSolicitudAsignadaComponent implements OnInit {
